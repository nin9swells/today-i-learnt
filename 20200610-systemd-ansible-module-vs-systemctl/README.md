I can use [ansible systemd](https://docs.ansible.com/ansible/latest/modules/systemd_module.html) to ensure certain state of certain unit. And these are available value of `state` parameter:
- reloaded
- restarted
- started
- stopped
